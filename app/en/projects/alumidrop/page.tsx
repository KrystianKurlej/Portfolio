...
const Page = () => {
  ...
  return (
    ...
    <p className="mb-4 font-light">Alumi Drop is a project that was created as part of one of the tasks during my studies. It serves as a creative advertising campaign for an imaginary brand specializing in aluminum bottles.</p>
    </>
  );
};
