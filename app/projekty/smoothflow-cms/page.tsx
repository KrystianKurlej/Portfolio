...
const Page = () => {
  return (
    ...
    <Image src='/img/SmoothFlow CMS - Mockup.jpg' alt="SmoothFlow CMS - Mockup" width={1050} height={701} className="rounded my-8"/>
    ...
    <Image src='/img/SmoothFlow CMS - Tailwind.jpg' alt="SmoothFlow CMS - Tailwind" width={1050} height={701} className="rounded my-8"/>
