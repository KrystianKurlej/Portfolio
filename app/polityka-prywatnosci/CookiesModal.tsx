...
const CookiesModal = () => {
  return (
    ...
    >
        ...
        <button className="mt-4 w-full px-4 h-10 flex items-center justify-center gap-2 bg-8 rounded-lg border border-neutral-500 hover:border-neutral-50 duration-150 text-sm">
          Rozumiem
        </button>
    </div>
  );
