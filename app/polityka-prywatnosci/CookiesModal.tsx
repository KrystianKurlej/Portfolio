...
const CookiesModal = () => {
  ...
  return (
    ...
    >
        ...
        <p className="text-xs mt-2 text-neutral-200 font-light">Przeglądając moje portfolio wyrażasz zgodę na używanie przeze mnie plików cookies. Informacje te wykorzystywane są tylko do celów statystycznych w celu usprawnienia strony. Więcej na ten temat dowiesz się w <Link href='/polityka-prywatnosci' className="font-medium text-white underline">Polityce prywatności.</Link></p>
        <button
